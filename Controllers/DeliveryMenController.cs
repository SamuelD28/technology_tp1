...
namespace technology_tp1.Controllers
{
    public class DeliveryMenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone")] DeliveryMan deliveryMan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone")] DeliveryMan deliveryMan)
        {
